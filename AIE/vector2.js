...
*/
Vec2.prototype.dot = function(pVec) {
...
*/
Vec2.prototype.rotate = function(pRot) {
...
*/
Vec2.prototype.lerp = function(pVec, pT) {
...
*/
Vec2.prototype.toString = function(pDecimal) {
    //Set the decimal place value
    pDecimal = (typeof pDecimal !== "number" ? 3 : pDecimal);
...
*/
Vec2.prototype.set = function(pVec) {
...
*/
Vec2.prototype.equal = function(pVec) {
    return (this.x === pVec.x && this.y === pVec.y);
};
...
*/
Vec2.prototype.notEqual = function(pVec) {
    return (this.x !== pVec.x || this.y !== pVec.y);
};
...
*/
Vec2.prototype.less = function(pVec) {
...
*/
Vec2.prototype.lessEqual = function(pVec) {
    return (this.sqrMag <= pVec.sqrMag);
};
...
*/
Vec2.prototype.greater = function(pVec) {
    return (this.sqrMag > pVec.sqrMag);
};
...
*/
Vec2.prototype.greaterEqual = function(pVec) {
    return (this.sqrMag >= pVec.sqrMag);
};
...
*/
Vec2.prototype.add = function(pVec) {
...
*/
Vec2.prototype.addSet = function(pVec) {
    //Add the axis values
    this.x += pVec.x;
    this.y += pVec.y;
...
*/
Vec2.prototype.subtract = function(pVec) {
    return new Vec2(this.x - pVec.x, this.y - pVec.y);
};
...
*/
Vec2.prototype.subtractSet = function(pVec) {
...
*/
Vec2.prototype.multi = function(pSclr) {
...
*/
Vec2.prototype.multiSet = function(pSclr) {
...
*/
Vec2.prototype.div = function(pSclr) {
    return new Vec2(this.x / pSclr, this.y / pSclr);
};
...
*/
Vec2.prototype.divSet = function(pSclr) {
